...
public class Segment2dTest
{
    ...
    {
        verifySegment("Segment from four coordinates", new Segment2d(1, 2, 3, 4), 1, 2, 3, 4);
        verifySegment("Segment from two coordinates and a Point2d", new Segment2d(1, 2, new Point2d(3, 4)), 1, 2, 3, 4);
        verifySegment("Segment from a Point2d and two coordinates", new Segment2d(new Point2d(1, 2), 3, 4), 1, 2, 3, 4);
        verifySegment("Segment from two Point2d objects", new Segment2d(new Point2d(1, 2), new Point2d(3, 4)), 1, 2, 3, 4);
        
        try
        {
            new Segment2d(1, 2, 1, 2);
        ...
        new Segment2d(1, 2, 1, 3);
        new Segment2d(1, 2, 0, 2);
    }
     ...
     */
    public void verifySegment(final String description, final Segment2d segment, final double expectedFromX,
    ...
    public void locationTest()
    {
        ...
        Segment2d segment = new Segment2d(startPoint, endPoint);
        try
        {
    ...
    {
        Segment2d segment = new Segment2d(1, 2, 20, 10);
        try
        {
