...
public class EventTest
{
    ...
    {
        EventType noMetaDataEventType = new EventType("No Meta Data", EventType.NO_META_DATA);
    ...
    public void testEventType()
    {
        ...
        assertNotEquals(eventType, new EventType("TEST_TYPE2", EventType.NO_META_DATA));
        ...
        assertEquals("Deprecated constructor uses NO_META_DATA for the meta data", EventType.NO_META_DATA,
    ...
    public void testEvent()
    {
        ...
        EventType eventType = new EventType("TEST_TYPE", EventType.NO_META_DATA);
        EventType eventType2 = new EventType("TEST_TYPE2", EventType.NO_META_DATA);
