...
/**
 * A {@link ImmutableSortedMap} extended with navigation methods reporting closest matches for given search targets.
 * Methods {@code lowerKey}, {@code floorKey}, {@code ceilingKey}, and {@code higherKey} return keys respectively less
 * than, less than or equal, greater than or equal, and greater than a given key, returning {@code null} if there is no
...
public interface ImmutableNavigableMap<K, V> extends ImmutableSortedMap<K, V>
{
     ...
     *             Implementations may, but are not required to, throw this exception if {@code fromKey} or
     *             {@code toKey} cannot be compared to keys currently in the immutable map.
     * @throws NullPointerException if {@code fromKey} or {@code toKey} is null and this immutable map does not permit
     *             null keys
     * @throws IllegalArgumentException if {@code fromKey} is greater than {@code toKey}; or if this immutable map
     *             itself has a restricted range, and {@code fromKey} or {@code toKey} lies outside the bounds of the
     *             range.
     */
     ...
     *             immutable map has no comparator, if {@code toKey} does not implement {@link Comparable}).
     ...
     * @throws IllegalArgumentException if this immutable map itself has a restricted range, and {@code toKey} lies
     ...
     * @throws IllegalArgumentException if this immutable map itself has a restricted range, and {@code fromKey} lies
     *             outside the bounds of the range
     */
