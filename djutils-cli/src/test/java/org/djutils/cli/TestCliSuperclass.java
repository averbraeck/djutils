...
public class TestCliSuperclass
{
    ...
    public void testCli() throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException, CliException
    {
        ...
        assertEquals(new Duration(60.0, Duration.Unit.s), optionsSub.getTimeout());
        ...
        assertEquals(new Duration(30.0, Duration.Unit.s), optionsChanged1.getTimeout());
        ...
        assertEquals(new Duration(30.0, Duration.Unit.s), optionsChanged2.getTimeout());
        ...
        assertEquals(new Duration(30.0, Duration.Unit.s), optionsChanged3.getTimeout());
