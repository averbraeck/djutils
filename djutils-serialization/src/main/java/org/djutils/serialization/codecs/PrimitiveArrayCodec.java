...
public abstract class PrimitiveArrayCodec<T> extends BasicCodec<T>
{
    ...
    public static final class ByteArrayCodec extends PrimitiveArrayCodec<byte[]>
    {
        /** Construct the ByteArrayCodec. */
        public ByteArrayCodec()
        {
            super(FieldTypes.BYTE_8_ARRAY, 1, "byte_8_array");
        }
        ...
        @Override
        public void serialize(final byte[] array, final byte[] buffer, final Pointer pointer, final Endianness endianness)
    ...
    public static final class ShortArrayCodec extends PrimitiveArrayCodec<short[]>
    {
        /** Construct the ShortArrayCodec. */
        public ShortArrayCodec()
        {
            super(FieldTypes.SHORT_16_ARRAY, 2, "short_16_array");
        }
        ...
        @Override
        public void serialize(final short[] array, final byte[] buffer, final Pointer pointer, final Endianness endianness)
                throws SerializationException
        {
            endianness.encodeInt(array.length, buffer, pointer.getAndIncrement(4));
            for (int i = 0; i < array.length; i++)
    ...
    /** Converter class for int array. */
    public static final class IntArrayCodec extends PrimitiveArrayCodec<int[]>
    {
        /** Construct the IntArrayCodec. */
        public IntArrayCodec()
        {
            super(FieldTypes.INT_32_ARRAY, 4, "int_32_array");
        }
    ...
    public static final class LongArrayCodec extends PrimitiveArrayCodec<long[]>
    {
        /** Construct the LongArrayCodec. */
        public LongArrayCodec()
        {
            super(FieldTypes.LONG_64_ARRAY, 8, "long_64_array");
        }
        ...
        @Override
        public void serialize(final long[] array, final byte[] buffer, final Pointer pointer, final Endianness endianness)
                throws SerializationException
        {
            endianness.encodeInt(array.length, buffer, pointer.getAndIncrement(4));
            for (int i = 0; i < array.length; i++)
    ...
    public static final class FloatArrayCodec extends PrimitiveArrayCodec<float[]>
    {
        /** Construct the FloatArrayCodec. */
        public FloatArrayCodec()
        {
            super(FieldTypes.FLOAT_32_ARRAY, 4, "float_32_array");
        }
        ...
        @Override
        public void serialize(final float[] array, final byte[] buffer, final Pointer pointer, final Endianness endianness)
                throws SerializationException
        {
            endianness.encodeInt(array.length, buffer, pointer.getAndIncrement(4));
            for (int i = 0; i < array.length; i++)
    ...
    public static final class DoubleArrayCodec extends PrimitiveArrayCodec<double[]>
    {
        /** Construct the DoubleArrayCodec. */
        public DoubleArrayCodec()
        {
            super(FieldTypes.DOUBLE_64_ARRAY, 8, "double_64_array");
        }
        ...
        @Override
        public void serialize(final double[] array, final byte[] buffer, final Pointer pointer, final Endianness endianness)
                throws SerializationException
        {
            endianness.encodeInt(array.length, buffer, pointer.getAndIncrement(4));
            for (int i = 0; i < array.length; i++)
    ...
    public static final class BooleanArrayCodec extends PrimitiveArrayCodec<boolean[]>
    {
        /** Construct the BooleanArrayCodec. */
        public BooleanArrayCodec()
        {
            super(FieldTypes.BOOLEAN_8_ARRAY, 1, "boolean_8_array");
        }
        ...
        @Override
        public void serialize(final boolean[] array, final byte[] buffer, final Pointer pointer, final Endianness endianness)
                throws SerializationException
        {
            endianness.encodeInt(array.length, buffer, pointer.getAndIncrement(4));
            for (int i = 0; i < array.length; i++)
