 ...
 */
public class VectorArraySerializer<U extends Unit<U>, S extends FloatScalar<U, S>, V extends FloatVector<U, S, V>>
        extends ObjectWithUnitSerializer<U, V[]>
{
    /** */
    public VectorArraySerializer()
    {
            ...
            throws SerializationException
    {
        ...
        for (int col = 0; col < width; col++)
        {
            try
            {
                ...
                result[col] = VectorSerializer.instantiateAnonymous(fvd, units[col]);
            }
