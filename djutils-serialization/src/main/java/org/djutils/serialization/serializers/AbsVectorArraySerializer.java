 ...
 */
public class AbsVectorArraySerializer<U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>>
        extends ObjectWithUnitSerializer<U, V[]>
{
    /** */
    public AbsVectorArraySerializer()
    {
            ...
            throws SerializationException
    {
        ...
        for (int col = 0; col < width; col++)
        {
            try
            {
                ...
                result[col] = AbsVectorSerializer.instantiateAnonymous(fvd, units[col]);
            }
