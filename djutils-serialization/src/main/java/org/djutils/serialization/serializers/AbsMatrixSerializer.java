 ...
 */
public class AbsMatrixSerializer<U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>,
        M extends DoubleMatrix<U, S, V, M>> extends ArrayOrMatrixWithUnitSerializer<U, M>
{
            ...
            throws SerializationException
    {
        ...
        for (int i = 0; i < adm.rows(); i++)
        {
            ...
            {
                endianness.encodeDouble(adm.get(i, j).si(), buffer, pointer.getAndIncrement(8));
            }
        }
    }
