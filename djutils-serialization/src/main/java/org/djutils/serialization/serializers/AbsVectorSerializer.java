 ...
 */
public class AbsVectorSerializer<U extends Unit<U>, S extends DoubleScalar<U, S>, V extends DoubleVector<U, S, V>>
        extends ArrayOrMatrixWithUnitSerializer<U, V>
{
            ...
            throws SerializationException
    {
        ...
        {
            endianness.encodeDouble(adv.get(i).si(), buffer, pointer.getAndIncrement(8));
        }
    }
