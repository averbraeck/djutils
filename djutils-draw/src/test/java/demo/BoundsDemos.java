 ...
 * BoundsDemos.java.
 * <p>
 * Copyright (c) 2021-2026 Delft University of Technology, PO Box 5, 2600 AA, Delft, the Netherlands. All rights reserved. <br>
...
public final class BoundsDemos
{
    ...
    public static void main(final String[] args)
    {
        ...
        Bounds2d b4 = line.getAbsoluteBounds(); // Of course, the PolyLine2d can create a Bounds2d by itself
