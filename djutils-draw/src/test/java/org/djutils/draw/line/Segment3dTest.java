...
public class Segment3dTest
{
    ...
    {
        verifySegment("Segment from four coordinates", new Segment3d(1, 2, 3, 4, 5, 6), 1, 2, 3, 4, 5, 6);
        verifySegment("Segment from two coordinates and a Point3d", new Segment3d(1, 2, 3, new Point3d(4, 5, 6)), 1, 2, 3, 4, 5,
                6);
        verifySegment("Segment from a Point3d and two coordinates", new Segment3d(new Point3d(1, 2, 3), 4, 5, 6), 1, 2, 3, 4, 5,
                6);
        verifySegment("Segment from two Point3d objects", new Segment3d(new Point3d(1, 2, 3), new Point3d(4, 5, 6)), 1, 2, 3, 4,
                5, 6);

        try
        {
            new Segment3d(1, 2, 3, 1, 2, 3);
        ...
        new Segment3d(1, 2, 3, 1, 2, 4);
        new Segment3d(1, 2, 3, 1, 3, 3);
        new Segment3d(1, 2, 3, 2, 2, 3);
     ...
     */
    public void verifySegment(final String description, final Segment3d segment, final double expectedFromX,
    ...
    {
        Segment3d segment = new Segment3d(1, 2, 3, 20, 10, 15);
        try
        {
